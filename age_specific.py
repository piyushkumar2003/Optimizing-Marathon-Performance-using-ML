# for women predictedchange index should be 0 in mask line.
import numpy as np
import pandas as pd
...
# Load the dataset
df = pd.read_csv("/content/test_data_ip - for specific age(25-29).csv")
...
mask = results['Predicted Change'].values == dummy['Predicted Change'][0]
